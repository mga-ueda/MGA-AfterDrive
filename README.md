...
OS のスタートアッププログラムの代替として、登録したアプリを遅延起動する Windows 用ユーティリティです。このアプリ自体をスタートアップに登録し、そこから各アプリを順に起動します。
...
本アプリをスタートアップ（またはタスク スケジューラ）に登録し、Setting に登録したアプリを Delay 付きで順次起動します。

> スタートアップからの起動に失敗する場合は、タスク スケジューラからの起動を試してください。
