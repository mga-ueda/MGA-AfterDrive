...
{
    private const string NoticesResource = "MGA_AfterDrive.Licenses.THIRD_PARTY_NOTICES.md";
    private const string WinBlurResource = "MGA_AfterDrive.Licenses.WinBlur-LICENSE.txt";
